...
<body onload="loadprint();">
	...
	?>
	<h2><u>Daftar Transaksi per Referensi</u></h2>
	<table border="0" cellspacing="0">
		...
		echo ("<tr><td><font face = verdana size = 2 color = black><b>Referensi :</b></font></td>");
		echo ("<td><font face = verdana size = 2 color = blue><b>$txtReff</b></font></td></tr>");
		?>
	</table>
	<table border="1" cellspacing="0">
		...
		WHERE TRSVALUTA >= '$trsdat1' AND TRSVALUTA <= '$trsdat2' AND TRSTOPC = '$trstopc' AND TRSTORF = '$txtReff' 
		ORDER BY TRSVALUTA";
		...
		<?php
				...
				if ($nRows > 0) {
					...
					echo ("<tr>");
					echo ("<th align = right><font face = verdana size = 2 color = black>" . "Hal. " . $nPage . "</font></th>");
					echo ("</tr>");
				}
			}
			$today = getdate();
			...
			$txtLogDesc = "Printing Report : Daftar Transaksi per Referensi";
