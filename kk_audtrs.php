...
<body>
	...
	<div class="easyui-panel" title="Audit Trail Transaksi" style="width:400px">
		<div style="padding:10px 0 10px 60px">
			<form id="ff" method="post">
				<table>
					...
					<tr>
						<td><input type="submit" name="btnDisplay" value="Display" formaction="kk_audtrs1.php"></input></td>
						<td><input type="submit" name="btnCetak" value="Cetak" formaction="kk_audtrs2.php"></input></td>
					</tr>
				</table>
			</form>
		</div>
