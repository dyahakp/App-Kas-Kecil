...
<body onload="loadprint();">
	...
	$sql = "SELECT TOP 1 BLCLVAL FROM BLMASTER WHERE BLTOPC = '$trstopc' AND BLDATE < '$trsdat1' ORDER BY BLDATE DESC";
	$result = sqlsrv_query($conn2, $sql);
	...
	<table border="1" cellspacing="0">
		...
		FROM TRMASTER  
		WHERE TRSVALUTA >= '$trsdat1' AND TRSVALUTA <= '$trsdat2' AND TRSTOPC = '$trstopc' AND TRSUSRAUT != '          ' 
