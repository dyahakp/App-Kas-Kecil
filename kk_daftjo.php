...
<body>
	...
	<div class="easyui-panel" title="Daftar Jurnal Otomatis" style="width:400px">
		<div style="padding:10px 0 10px 60px">
			<form id="ff" method="post">
				<table>
					...
					<tr>
						<td><input type="submit" name="btnDisplay" value="Display" formaction="kk_daftjo1.php"></input></td>
						<td><input type="submit" name="btnCetak" value="Cetak" formaction="kk_daftjo2.php"></input></td>
					</tr>
				</table>
			</form>
		</div>
